                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call <code className="text-xs">window.HaviAIWidget.start()</code> to begin a call.</li>
                                                    <li>• Call <code className="text-xs">window.HaviAIWidget.end()</code> to end it.</li>
...
window.HaviAIWidget?.onStatusChange((status) => {
  callStatus = status;
...
document.getElementById('talk-btn').addEventListener('click', () => {
  if (callStatus === 'connected' || callStatus === 'connecting') {
    window.HaviAIWidget.end();
  } else {
    window.HaviAIWidget.start();
  }
});`}</code>
                                                </pre>
  ...
  useEffect(() => {
    window.HaviAIWidget?.onStatusChange(setStatus);
  }, []);

  const isLive = status === 'connected' || status === 'connecting';
  return (
    <button onClick={() => isLive ? window.HaviAIWidget.end() : window.HaviAIWidget.start()}>
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call window.HaviAIWidget.start() to begin the call</li>
                                                    <li>• Call window.HaviAIWidget.end() to end the call</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div className="rounded-lg bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800">
                                                ...
                                                <pre className="text-xs overflow-x-auto">
                                                    <code className="text-blue-800 dark:text-blue-200">{`export function HaviAIAgent() {
  const [isCallActive, setIsCallActive] = useState(false);

  useEffect(() => {
    // Widget will auto-initialize when script loads
    window.HaviAIWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.HaviAIWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <button
        onClick={() => window.HaviAIWidget?.start()}
